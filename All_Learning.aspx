<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false"
    CodeFile="All_Learning.aspx.vb" Inherits="Default2" %>
...
<%--لیست زیر مجموعه های این قسمت بیاید--%>
</asp:Content>
...
<asp:Label ID="DateTimeLabel" runat="server" Style="font:normal 11px tahoma" Text='<%# convertDATE(Eval("DateTime")) %>' />
</td>
</tr>
<tr>
<td>
...
<asp:SqlDataSource ID="SDS_All" runat="server" ConnectionString="<%$ ConnectionStrings:GraphicMotionConnectionString %>" SelectCommand="SELECT * FROM [tbl_Learning_and_Films] WHERE ([Category] = @Category) and ([flag]=1) ORDER BY [ID] DESC">
<SelectParameters>
