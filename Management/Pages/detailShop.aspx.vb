...
Partial Class Management_Pages_detailShop
    ...
    Protected Sub btnBaresi_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBaresi.Click
        Dim ds As New DSTableAdapters.Buy_UserTableAdapter
        ds.UpdateFlag(2, Request.QueryString("cookieid"), Request.QueryString("codepey"), Request.QueryString("authority"))
        lblStatus.Text = "وضعیت: در حال بررسی"
