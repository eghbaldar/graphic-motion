...
Partial Class Default2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            CP()
        End If
        Page.Title = Page.RouteData.Values("title").ToString.Replace("-", " ").Replace(".html", "") + " | دانلود آموزش"
        ...
        'Try
            ...
            Metag.Create_MetaTag_Description(Page.Master.FindControl("mainHead"), Page.RouteData.Values("title").ToString.Replace("-", " ").Replace(".html", "") + " دانلود آموزش تصویری")
