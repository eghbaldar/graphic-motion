...
<style type="text/css">.ContanierDetail{background-color:#afc0d1;padding:10px;-moz-border-radius:5px;-webkit-border-radius:5px;border-radius:5px;width:580px;font:normal 14px tahoma}.ContanierDetail img{max-width:100%;max-height:100%}</style>
</asp:Content>
...
<ItemTemplate>
<asp:Panel ID="Panel2" runat="server" Visible='<%# iif(eval("link_film")=".",false,true) %>'>
...
<tr>
<td>
<asp:ImageButton OnCommand="SetDownload" CommandArgument='<%# Eval("link_film","{0}") %>' ImageUrl="~/Content/img/mnu_download.png" ID="ImageButton1" runat="server" />
</td>
<td>
<asp:Panel ID="Panel3" runat="server" Visible='<%# iif(eval("link_project")=".",false,true) %>'>
<a href='<%# Eval("link_project","{0}") %>' target="_blank">
<img src="<%= Page.ResolveUrl("~/Content/img/mnu_project.png") %>" alt="توضیحات" title="دانلود پروژه" />
</a>
</asp:Panel>
</td>
</tr>
...
<div id="ViewPostRight_Store" style="margin-bottom:5px;">
...
<h4 style="margin-bottom:13px;margin-top:7px;color:White">
<asp:Label ID="titleLabel" runat="server" Text='<%# Eval("title") %>' />
</h4>
</div>
</td>
...
<script>/*<![CDATA[*/(function(e,a,f){var c,b=e.getElementsByTagName(a)[0];if(e.getElementById(f)){return}c=e.createElement(a);c.id=f;c.src="//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.6";b.parentNode.insertBefore(c,b)}(document,"script","facebook-jssdk"));/*]]>*/</script>
<div class="fb-like" data-href='<%#  String.Format("../../post/{1}/{0}", Eval("title"), Eval("id")).ToString().Replace(" ","-")+".html" %>' data-layout="standard" data-action="like" data-show-faces="false" data-share="true">
</div>
</td>
</tr>
<tr>
...
<tr style="font:normal 16px koodak">
<td>
...
<tr>
<td>
<div class="ContanierDetail" style="font-family:koodak">
